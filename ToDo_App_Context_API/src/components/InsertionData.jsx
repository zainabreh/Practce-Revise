...
function InsertionData() {
  ...
  const {updateToDo} = useContext(ContextAPI)
    ...
    const UpDate = ()=>{
      ...
      : todoText == false && todoDate ? alert("Enter ToDo") : updateToDo(todoText,todoDate) == true ? alert("APP IS UNDER MAINTENANCE") :  settodoDate('') || settodoText('')
